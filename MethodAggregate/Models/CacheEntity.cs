...
namespace MethodAggregate.Models
{
        ...
        public object Parameter
        {
            get
            {
                ...
                else
                {
                    ...
                    var param = (parameters == null || parameters.Count() == 0) ? null : JsonSerializer.DeserializeFromString(this.MethodParameter, parameters[0].ParameterType);
                    return param;
                }
            }
        }
