...
namespace MethodAggregate.RunnerOptions
{
    public class RunnerOption : RunnerOptionBase
    {
        ...
        public Func<RunnerMailOptionContext, MailOption> MailOptionConstructor { get; set; }
    ...
    public class RunnerOption<T> : RunnerOptionBase
    {
        ...
        public Func<RunnerMailOptionContext<T>, MailOption> MailOptionConstructor { get; set; }
    ...
    public class RunnerOption<TRequest, TResponse> : RunnerOptionBase
    {
        ...
        public Func<RunnerMailOptionContext<TRequest, TResponse>, MailOption> MailOptionConstructor { get; set; }
